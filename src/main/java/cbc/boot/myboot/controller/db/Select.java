...
public class Select {
    ...
    public ResponseEntity<List<Object>> select(@RequestBody String param, HttpServletRequest request,
    ...
    public ResponseEntity<List<Object>> selectByBatch(@RequestBody String param, HttpServletRequest request,
            HttpServletResponse response) {
        System.out.println("----------Start(Author:陈斌才)----------");
        System.out.println("执行select操作!");
        System.out.println("传入参数:");
